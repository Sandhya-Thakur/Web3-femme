...
import { client, exploreProfiles } from './Profiles'
  ...
  return (
    <div className='pt-5'>
      <div className='flex flex-col justify-left items-left'>
        <h1 className='text-pink-600 flex flex-col justify-center items-center text-5xl mb-6 font-bold'>Hello Divas </h1>
        {
